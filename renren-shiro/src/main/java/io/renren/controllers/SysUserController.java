...
public class SysUserController extends AbstractController {
	...
	public R password( String password, String newPassword){
		...
		//MD5加密 update by cyl
		ByteSource credentialsSalt =ByteSource.Util.bytes(getUsername());
		Object result= new SimpleHash("MD5", password,credentialsSalt, 3);
		password=result.toString();
		result=new SimpleHash("MD5", newPassword,credentialsSalt, 3);
